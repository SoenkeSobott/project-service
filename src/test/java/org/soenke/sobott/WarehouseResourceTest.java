...
public class WarehouseResourceTest {
    ...
    public void testGetAllArticlesEndpoint() {
        ...
        given()
                ...
                .body("articles[0].articleDescription", is("Test description"))
                .body("articles[0].weight", is(200.34f))
                .body("articles[0].listPrice", is(89000f))
                .body("articles[0].availability", is(0))
                .body("articles[1].articleNumber", is("56788"))
                .body("articles[1].articleDescription", is("House Project 00X"))
                .body("articles[1].weight", is(20.34f))
                .body("articles[1].listPrice", is(1080f))
                .body("articles[1].availability", is(23))
                .body("articles[2].articleNumber", is("123BB"))
                .body("articles[2].articleDescription", is("MegaProject0815"))
                .body("articles[2].weight", is(24f))
                .body("articles[2].listPrice", is(1022f))
                .body("articles[2].availability", is(2012));
    }
